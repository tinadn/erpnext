...
class TestPurchaseReceipt(FrappeTestCase):
	...
	def test_stock_issue_TC_SCK_223(self):
		...
		self.qty_reserved = 3
		self.company = "_Test Company"
		# Commenting due to precommit error: F841 Local variable `se1` is assigned to but never used
	...
	def test_purchase_receipt_submission_TC_SCK_147(self):
		...
		# Commenting due to precommit error:  F841 Local variable `item_fields` is assigned to but never used
		# item_fields = {
		...
		# Commenting due to precommit error:  F841 Local variable `item` is assigned to but never used

		# item = make_item("Ball point Pen", item_fields).name
		# self.item_code = "Ball Point Pen"

		# Commenting due to precommit error: F841 Local variable `supplier` is assigned to but never used
	...
	def test_adjust_incoming_rate_for_pr_TC_SCK_265(self):
		...
		pr.reload()
		# Commenting due to precommit error:  F841 Local variable `original_valuation_rate` is assigned to but never used
