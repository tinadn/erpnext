...
class TestDimensionWiseAccountsBalanceReport(unittest.TestCase):
    ...
    def test_get_dimensions_fetches_names(self, mock_get_all, mock_get_meta):
    ...
    def test_get_columns_with_dimensions(self):
    ...
    def test_accumulate_values_into_parents(self):
        accounts = [
    ...
    def test_prepare_data_creates_rows(self):
    ...
    def test_format_gl_entries_adds_dimension_values(self):
        accounts_by_name = {
    ...
    def test_get_data_calls_dependencies(
